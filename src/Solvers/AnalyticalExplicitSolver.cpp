#include "AnalyticalExplicitSolver.h"
...
void AnalyticalExplicitSolver::solve()
{
...
std::vector<std::array<double,3>> AnalyticalExplicitSolver::get_analytical_solution() const
{
