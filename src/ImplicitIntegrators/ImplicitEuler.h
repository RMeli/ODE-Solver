...
public:
   ...
   */
  ImplicitEuler(double (*ODE_)(double, double),
                double dx_,
...
private:
  ...
  /*!
   ...
   This class is defined as a nasted class of the ImplicitEuler integrator in
  ...
  public:
    //! Constructor.
    /*!
     Take a pointer to an ImplicitEuler integrator. This link is needed because
     the functions f and df that define implicit method needs private members of
     the ImplicitIntegrator class.
     */
    ...
    /*!
     Derivative of the nonlinear function defining the implicit Euler method
  ...
  private:
    ...
    /*!
     ...
     No destructor needed because ImplcitiEuler destruction is handled by the
     ImplicitSolver.
     */
    ImplicitEuler* IE;
  };
  ...
  /*!
   The IEFunction class is defined here as a nasted class. However, obviously,
   an instance of the class is needed and this pointer is used to store an
   IEFunction object: we have a double link between IEFunction and ImplicitEuler
   integrator (each class points to the other). A the IEFunction is initialized
   inside the constructor of the ImplicitEuler with the this pointer, no
   mismatch is allowed.
   */
  IEFunction* IEF;
};
